...
from src.gui.theme_colors import MENU_BG, TEXT_PRIMARY, TEXT_SECONDARY, get_color
...
class FrameCamPreview(SafeDisposableFrame):
    ...
    def __init__(self, master, master_callback: callable, **kwargs):
        ...
        self.toggle_label = customtkinter.CTkLabel(
            master=self,
            compound='right',
            text="Permite que gestos faciales\ncontrolen tus acciones. ",
    ...
    def camera_loop(self):
        ...
        try:
            ...
            # Asignar referencia para evitar la recolección de basura
            ...
            logging.getLogger("frame_preview").error(f"camera_loop error: {e}")
        finally:
