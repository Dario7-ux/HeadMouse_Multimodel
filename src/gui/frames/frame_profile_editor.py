...
from src.gui.theme_colors import BG_CARD, SUCCESS_BG, DANGER_BG, ACCENT, get_color
...
class FrameProfileEditor():
    ...
    def __init__(self, root_window, main_gui_callback: callable, **kwargs):
        ...
        des_label = customtkinter.CTkLabel(
            ...
            text=
            "Con el administrador de perfiles puedes crear y administrar múltiples perfiles para cada uso, para que puedas cambiar fácilmente entre ellos.",
            wraplength=300,
            justify=tk.LEFT)
