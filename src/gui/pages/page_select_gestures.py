...
BALLOON_TXT = "Establece qué tan prominente debe ser\ntu gesto para activar la acción"
...
class FrameSelectGesture(SafeDisposableFrame):
    ...
    def set_div_inactive(self, div):
        ...
        div["combobox"].set(shape_list.gesture_translation_map.get(none_gesture, none_gesture))
    ...
    def dropdown_callback(self, caller_name: str, target_gesture: str):
        ...
        div["combobox"].set(shape_list.gesture_translation_map.get(target_gesture, target_gesture))
...
class PageSelectGestures(SafeDisposableFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        # Description.
        des_txt = "Selecciona un gesto facial que desees vincular a una acción específica del ratón. La sensibilidad te permite controlar qué tan pronunciado debe ser tu gesto para activar la acción del ratón"
