...
from src.gui.theme_colors import TEXT_PRIMARY, TEXT_SECONDARY
...
class PageSelectCamera(SafeDisposableFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        # Label
        self.label = customtkinter.CTkLabel(master=self, text="Selecciona una Cámara",
    ...
    def load_initial_config(self):
        ...
        self.radios = radios
        self.radio_var.set(target_id)
        self.prev_radio_value = target_id
    ...
    def page_loop(self):
        ...
        try:
            ...
            logger.error(f"page_loop error: {e}")
        finally:
