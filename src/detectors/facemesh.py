...
MP_TASK_FILE = get_resource_path("assets/task/face_landmarker_with_blendshapes.task")
...
class FaceMesh(metaclass=Singleton):
    ...
    def start(self):
        if not self.is_started:
            ...
            # En Windows, se necesita abrir el búfer directamente
